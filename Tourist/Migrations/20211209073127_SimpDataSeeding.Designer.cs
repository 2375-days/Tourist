...
namespace Tourist.API.Migrations
{
    ...
    [Migration("20211209073127_SimpDataSeeding")]
    partial class SimpDataSeeding
    {
            ...
            modelBuilder.Entity("Tourist.API.models.TouristRoute", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ffcd70c5-a3a4-4afa-a4ad-c5fe720d9ec3"),
                            CreateTime = new DateTime(2021, 12, 9, 7, 31, 27, 135, DateTimeKind.Utc).AddTicks(4233),
                            Description = "测试数据2",
                            OriginalPrice = 0m,
                            Title = "测试数据"
                        });
